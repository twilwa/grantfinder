...
The system SHALL publish proposal-workspace artifacts, application drafts, and
...
#### Scenario: Proposal workspace artifacts publish into the linked repository
- **WHEN** an authenticated requester or collaborator updates proposal-workspace
  state or runs a proposal-side agent action for a repository-linked pursuit
